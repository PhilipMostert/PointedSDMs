...
#' @param speciesIndependent Logical argument: Should species effects be made independent of one another. Defaults to \code{TRUE} which creates effects for each species independently.

...
As mentioned above, there are some slot functions now inside the `spatial_data` objects, which allow for a finer level of customization of the components for the integrated model. Documentation for these slot functions may be found by using
...
caerulescensModel$specifyRandom(copyBias = list(beta = list(fixed = TRUE)))
